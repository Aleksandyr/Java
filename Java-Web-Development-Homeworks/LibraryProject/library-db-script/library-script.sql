...
CREATE SEQUENCE AUTHORITIES_SEQ1;
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.ID IS NULL THEN
      SELECT AUTHORITIES_SEQ1.NEXTVAL INTO :NEW.ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;

-- user_authority primary key sequence
CREATE SEQUENCE USER_AUTHORITY_SEQ1;
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.ID IS NULL THEN
      SELECT USER_AUTHORITY_SEQ1.NEXTVAL INTO :NEW.ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;

-- books primary key sequence
CREATE SEQUENCE BOOKS_SEQ1;
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.ID IS NULL THEN
      SELECT BOOKS_SEQ1.NEXTVAL INTO :NEW.ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;

-- lends primary key sequence
CREATE SEQUENCE LENDS_SEQ1;
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.ID IS NULL THEN
      SELECT LENDS_SEQ1.NEXTVAL INTO :NEW.ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
