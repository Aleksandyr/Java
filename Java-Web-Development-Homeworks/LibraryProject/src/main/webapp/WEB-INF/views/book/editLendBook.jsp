...
<body>
	<c:if test="${not empty book && not empty lendBook}">
		<form:form style="width:20%; height: 20%; margin-left: auto; margin-right: auto;" name="edit" class="form-edit" id="edit-form" action="/library/books/lends/edit/${book.getId()}/${lendBook.getId()}" method="POST">
