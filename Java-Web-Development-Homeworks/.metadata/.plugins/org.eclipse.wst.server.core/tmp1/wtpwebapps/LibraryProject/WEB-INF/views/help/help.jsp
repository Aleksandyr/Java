...
<ct:Header username="${username}"></ct:Header>
	<div id="wrapper" style="width: 1100px; height: 500px; margin: 0 auto;">
		...
		<table class="help-page-table">
		    ...
		    <tbody>
		        <ct:ApiTableCol urlPath="/account/login" methodType="GET" description="Login page."></ct:ApiTableCol>
		        <ct:ApiTableCol urlPath="/account/logout" methodType="POST" description="Logout."></ct:ApiTableCol>
		    </tbody>
		</table>
